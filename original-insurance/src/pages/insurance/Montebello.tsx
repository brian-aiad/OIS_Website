...
export default function MontebelloPage() {
  ...
  return (
    <main id="main-content">
      ...
      <InsuranceWorkflow
        tone="offwhite"
        title="How we quote Montebello coverage"
        lede="We compare carrier fit for Montebello drivers, homeowners, renters, and businesses with clear next steps before you buy."
      />
