...
export default function NotFound() {
  usePageMeta({
    title: "Page Not Found (404) | Original Insurance Services",
    description:
      "The page you're looking for doesn't exist. Head back to our homepage or contact Original Insurance Services in Downey, CA at (310) 538-8666 for help.",
    canonical: "https://originalinsurance.net/404",
  });
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            ...
            <nav className="flex flex-wrap justify-center gap-2">
              {[
                ...
                { to: "/locations", label: "Our Downey Office" },
