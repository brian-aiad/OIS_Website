...
export default function Accessibility() {
  usePageMeta({
    title: "Accessibility | Original Insurance",
    description: "Original Insurance provides accessible online and offline ways to request insurance help in English, Spanish, and Arabic.",
    canonical: "https://originalinsurance.net/accessibility",
  });
    ...
    <main id="main-content">
      <BreadcrumbSchema
        crumbs={[
          ...
          { name: "Accessibility", url: "https://originalinsurance.net/accessibility" },
        ]}
      />
      ...
      <section className="sp bg-slate-50">
        <div className="container max-w-4xl">
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            ...
            <a href={site.contact.mapsHref} target="_blank" rel="noreferrer" className="btn btn-outline">Visit the Downey office</a>
          </div>
        </div>
      </section>
    </main>
