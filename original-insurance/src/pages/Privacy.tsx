...
const practices = [
  {
    ...
    text: "Our general contact form asks for your name, contact information, topic, and message. Quote details are collected separately through our quote provider.",
  },
  {
    Icon: LockKeyhole,
...
export default function Privacy() {
  usePageMeta({
    title: "Privacy & Data Handling | Original Insurance",
    description: "Learn how Original Insurance handles website inquiries, quote requests, analytics, and sensitive insurance information.",
    canonical: "https://originalinsurance.net/privacy",
  });
    ...
    <main id="main-content">
      <BreadcrumbSchema
        crumbs={[
          ...
          { name: "Privacy", url: "https://originalinsurance.net/privacy" },
        ]}
      />
      ...
      <section className="hero-mesh overflow-hidden text-white">
        <div className="container relative py-20 md:py-28">
          ...
          <p className="mt-5 text-sm font-medium text-gold-200">Last updated July 30, 2026</p>
        </div>
      </section>
        ...
        <div className="container max-w-5xl">
          <div className="grid gap-10 lg:grid-cols-[0.9fr,1.1fr]">
            ...
            <div className="space-y-4">
              {[
                ["General messages", "The contact form uses Web3Forms to deliver your inquiry to our office."],
                ["Quote requests", "The quote experience is provided through Quotzal and opens in an embedded frame or a separate browser tab."],
